...
/// Xử lý các yêu cầu đến các đường dẫn không được đinh nghĩa (404 Not Found)
...
Response _rootHandler(Request req) {
  // Cóntructor `ok` của Response có statusCode là 200
  return Response.ok(
...
/// Hàm xử lý yêu cầu tại hướng dẫn '/api/v1/check'
Response _checkHandler(Request req) {
  return Response.ok(
    json.encode({'message': 'chào mừng bạn đến với ứng dụng web đọng'}),
    headers: _headers,
  );
}
...
void main(List<String> args) async {
  ...
  // Nếu biến môi tường không được thiết lập nó sẽ sử dụng giá trị từ biến
