...
// Widget MainApp là widget gốc của ứng dụng StatelessWidget
  ...
  Widget build(BuildContext context) {
    return const MaterialApp(
        debugShowCheckedModeBanner:
            false, // Tắt biểu tượng debug ở góc phải trên
...
/// để quản lsy trạng thái do có nội dung cần thay đổi trên trang này
